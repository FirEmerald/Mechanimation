package firemerald.mechanimation.compat.jei.gas;
...
public class GasStackRenderer implements IIngredientRenderer<GasStack> {
    ...
    public List<String> getTooltip(Minecraft minecraft, GasStack gasStack, ITooltipFlag tooltipFlag) {
        ...
        if (tooltipMode == TooltipMode.SHOW_AMOUNT_AND_CAPACITY) {
            String amount = Translator.format("jei.tooltip.liquid.amount.with.capacity", gasStack.amount, capacityMb);
            tooltip.add(TextFormatting.GRAY + amount);
        } else if (tooltipMode == TooltipMode.SHOW_AMOUNT) {
            String amount = Translator.format("jei.tooltip.liquid.amount", gasStack.amount);
            tooltip.add(TextFormatting.GRAY + amount);
        }
        return tooltip;
    }
