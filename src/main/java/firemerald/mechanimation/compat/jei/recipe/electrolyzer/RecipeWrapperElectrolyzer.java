...
public class RecipeWrapperElectrolyzer extends RecipeWrapperFluxReciever
{
	/* Recipe */
    protected IElectrolyzerRecipe recipe;

	public RecipeWrapperElectrolyzer(IGuiHelper guiHelper, IElectrolyzerRecipe result, String uIdIn)
	{
