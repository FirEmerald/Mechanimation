...
import firemerald.mechanimation.api.crafting.arc_furnace.ArcFurnaceRecipeTool;
import firemerald.mechanimation.api.crafting.arc_furnace.IArcFurnaceRecipe;
import net.minecraft.util.JsonUtils;
import net.minecraftforge.common.crafting.JsonContext;

public class ArcFurnaceToolRecipeFactory implements ICraftingFactory<RecipeKey, IArcFurnaceRecipe>
{
	@Override
	public IArcFurnaceRecipe parse(RecipeKey key, JsonContext context, JsonObject obj)
	{
		...
		return new ArcFurnaceRecipeTool(input, output, temperature - 300);
	}
}
