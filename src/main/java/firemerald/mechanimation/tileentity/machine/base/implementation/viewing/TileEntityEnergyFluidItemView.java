...
public abstract class TileEntityEnergyFluidItemView<T extends IEnergyMachine<T> & IFluidMachine<T> & IItemMachine<T>> extends TileEntityFluidItemView<T> implements IEnergyMachine<T>
{
