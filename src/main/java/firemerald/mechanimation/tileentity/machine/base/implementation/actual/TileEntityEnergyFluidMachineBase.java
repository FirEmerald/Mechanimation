...
public abstract class TileEntityEnergyFluidMachineBase<T extends TileEntityEnergyFluidMachineBase<T, R>, R> extends TileEntityFluidMachineBase<T, R> implements IEnergyGuiMachine<T>
{
