...
public abstract class TileEntityEnergyItemMachineBase<T extends TileEntityEnergyItemMachineBase<T, R>, R> extends TileEntityItemMachineBase<T, R> implements IEnergyGuiMachine<T>
{
