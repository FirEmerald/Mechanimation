...
public abstract class TileEntityFluidItemMachineBase<T extends TileEntityFluidItemMachineBase<T, R>, R> extends TileEntityItemMachineBase<T, R> implements IFluidMachine<T>, IFluidGuiMachine<T>
{
