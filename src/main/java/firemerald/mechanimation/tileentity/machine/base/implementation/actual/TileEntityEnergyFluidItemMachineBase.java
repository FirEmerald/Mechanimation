...
public abstract class TileEntityEnergyFluidItemMachineBase<T extends TileEntityEnergyFluidItemMachineBase<T, R>, R> extends TileEntityFluidItemMachineBase<T, R> implements IEnergyMachine<T>, IFluidGuiMachine<T>, IEnergyGuiMachine<T>
{
	...
	@SuppressWarnings("unchecked")
	public TileEntityEnergyFluidItemMachineBase(Function<T, IItemInventory<T>> itemInventory, Function<T, IFluidInventory<T>> fluidInventory, Function<T, IEnergyInventory<T>> energyInventory)
	{
