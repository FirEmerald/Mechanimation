...
public abstract class TileEntityEnergyFluidItemMachineBase<T extends TileEntityEnergyFluidItemMachineBase<T, R>, R> extends TileEntityFluidItemMachineBase<T, R> implements IEnergyGuiMachine<T>
{
