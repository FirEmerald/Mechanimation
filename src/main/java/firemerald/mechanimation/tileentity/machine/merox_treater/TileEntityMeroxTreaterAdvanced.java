...
public class TileEntityMeroxTreaterAdvanced extends TileEntityMeroxTreater<TileEntityMeroxTreaterAdvanced>
{
	@Override
	...
	{
		return MCMSModel.MEROX_TREATER_ADVANCED.model.get();
	}

	@Override
	public ResourceLocation getTexture()
	{
		return MCMSTexture.MEROX_TREATER_ADVANCED;
	}
	...
	{
		return MechanimationStats.ADVANCED_MEROX_TREATER_INTERACTION;
	}
}