...
public class BlockBlastFurnaceMultiblock<T extends BlockBlastFurnace> extends BlockContainer
{
    public final T parent;

	public BlockBlastFurnaceMultiblock(T parent)
	{
	...
	{
		return new TileEntityBlastFurnaceTop();
	}
