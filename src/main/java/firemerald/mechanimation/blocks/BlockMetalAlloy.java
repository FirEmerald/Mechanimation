...
public class BlockMetalAlloy extends Block implements IItemSubtyped //TODO hardness/resistance
{
	...
	public BlockMetalAlloy()
	{
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumVariant.STEEL));
        this.setHarvestLevel(EnumVariant.STEEL, 3);
	...
	{
		STEEL("steel", MapColor.IRON, 5, 10);
