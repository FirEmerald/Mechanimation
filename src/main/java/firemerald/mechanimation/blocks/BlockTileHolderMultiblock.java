...
public class BlockTileHolderMultiblock<T extends Block & IBlockMultiblockParent & ITileEntityProvider> extends BlockBasicMultiblock<T> implements ITileEntityProvider
{
    public final T parent;
    public final BiFunction<World, Integer, TileEntity> newTile;

	public BlockTileHolderMultiblock(T parent, MapColor mapColor, BiFunction<World, Integer, TileEntity> newTile)
	{
		super(parent, mapColor);
		this.parent = parent;
	...
	{
		return newTile.apply(worldIn, meta);
	}
}